...
|---------|-----------------|
| **Учасник 1** | Django models, Admin panel, Docker, GitHub Actions (lint + docker jobs) |
| **Учасник 2** | Django views, Templates, Tests, GitHub Actions (test + summary jobs) |
...
- ⚙️ Django Admin Panel для управління
